...
class Spider_baidu_image():
    def __init__(self):
        ...
        self.headers_image = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.\
            3497.81 Safari/537.36',
            'Referer': 'https://image.baidu.com/search/index?tn=baiduimage&ps=1&ct=201326592&lm=-1&cl=2&nc=1&ie=utf-8&dyTabStr=MCwzLDEsNiw0LDIsNSw3LDgsOQ%3D%3D&word=%E7%8B%AD%E5%8F%B6%E7%93%B6%E5%B0%94%E5%B0%8F%E8%8D%89'}
        # self.keyword = '刘亦菲壁纸'
